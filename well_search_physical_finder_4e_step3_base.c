...
int main(int argc, char **argv)
{
        ...
        strcmp(argv[1], "4e") == 0)
    {
        ...
        for (int i = 0; i < count; i++)
        {
             ...
             *
             * The candidate index is mixed with different
             * constants so Seed/X/Z do not share the same
             * generated value.
             */
            ...
            printf(
                "4E Candidate %llu: seed=%lld X=%lld Z=%lld\n",
             ...
             * CRITICAL:
             *
             * The exact existing verified worker() is used.
             * No well-generation logic is duplicated here.
             */
            ThreadResult *r =
                (ThreadResult *)worker(&one);
        ...
        printf("========================================\n");
        printf(" 4E STEP 1 TEST COMPLETE\n");
        printf("========================================\n");
        printf("Candidates tested : %d\n", count);
        printf("Seeds scanned     : %llu\n",
            (unsigned long long)totalSeeds);
