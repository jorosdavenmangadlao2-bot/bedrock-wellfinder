...
{
    /*
     * Physical 4-well chain:
     *
     * W1 -- W2 -- W3 -- W4
     *
     * Every neighboring pair touches.
     * The first and last wells do not touch.
     */
    ...
    printf("========================================\n");
    printf(" Physical 4-Well Regression Test\n");
    printf("========================================\n");
    ...
    printf("RESULT: %s\n",
        allConnected
            ? "PASS - ONE CONNECTED 4-WELL COMPONENT"
            : "FAIL");
